  ...
  try {
    ...
    await prisma.student.create({
      data: {
        ...
        takes_external_tutorship: data.takes_external_tutorship
      },
    });
  ...
  try {
    ...
    await prisma.parent.create({
      data: {
        ...
        parent_highest_education_level: data.parent_highest_education_level,
        parent_support_index: data.parent_support_index || null,
      },
    });
